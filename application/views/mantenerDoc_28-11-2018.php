					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" id='fecha_ingreso_camion' readonly class="form-control">
							</div>
						</div>
						<div class="col-sm-2">
							<div class="form-group">
					...
					<div class="container-fluid">
						<div class="row">
							...
							<!-- <div class="col-sm-3">
								<div class="form-group">
									<label>Fecha ingreso</label>
									<input type="text" id='fecha_ingreso_rampla' readonly class="form-control">
								</div>
							</div> -->
							<!-- <div class="col-sm-2">
								<div class="form-group">
									<label>Ficha rampla</label>
									<a class="btn btn-default btn-block" id='verFichaRampla' data-toggle="tooltip" data-placement="bottom" title="Ver ficha"><i class="glyphicon glyphicon-list-alt pull-left"></i>Detalle rampla</a>
								</div>
							</div> -->
							<!-- <div class="col-sm-6 col-sm-offset-4">
								<div class="table-responsive">
			...
			<div class="box-body no-padding"><br/>
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-sm-2">
							<center><img src="<?php echo base_url()?>/fotos/perfil.png" class="img-perfil img-circle" id="fotoChofer"></center>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
			...
			<div class="box-body no-padding"><br/>
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-sm-2">
							<center><img src="<?php echo base_url()?>/fotos/perfil.png" class="img-perfil img-circle" id="fotoAyudante"></center>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
		...
		function cargarDocsCamion(camion){
			...
			$.post(url, {camion:camion}, function(data) {
				$.each(data, function (i, obj) {
					...
					var ruta_doc='';
					if (oficina == '50') {
						if (obj.ID_TIPO_DOC !== '28' && obj.ID_TIPO_DOC !== '27') {
							if(obj.PATH_DOC !=null){
								ruta_doc="<?php print base_url()."doc/"?>"+obj.PATH_DOC;
							}else{
								ruta_doc=obj.FULL_PATH;
		...
		function cargarImagenesCamion(cod_camion){
			...
			$.ajax({
				...
				if(data.length>0){
					...
					$.each(data, function(i, obj) {
						var ruta_imagen;
						if(obj.PATH_IMG_CAMION == "" || obj.PATH_IMG_CAMION == null){
							ruta_imagen=obj.FULL_PATH;
						}else{
							ruta_imagen=base_url+'imgCamion/'+obj.PATH_IMG_CAMION;
						}
						fila+='<td><img class="camionIMG-mantenedor img-responsive fancybox img-thumbnail" src="'+ruta_imagen+'" href="'+base_url+'imgCamion/'+obj.PATH_IMG_CAMION+'"/></td>';
						if(cont==5){
							fila+='</tr>'
							cont=0;
						}
